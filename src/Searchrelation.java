...
@WebServlet("/Searchrelation")
public class Searchrelation extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String query="{\"statements\":[{\"statement\":\" MATCH p=(n{名称:"+"'"+name+"'"+"})-[*.."+series+"]-() return p\",\"resultDataContents\":[\"graph\"]}]}";
