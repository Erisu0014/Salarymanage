...
@WebServlet("/Multientity")
public class Multientity extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String query="{\"statements\":[{\"statement\":\" match (m{名称:"+"'"+name1+"'"+"}),(n{名称:"+"'"+name2+"'"+"}) "
				+ "optional match (m)-[r*1..4]-(n) "
				+ "return m,n,r\",\"resultDataContents\":[\"graph\"]}]}";
