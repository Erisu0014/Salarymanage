...
<html>
   <head>
	...
	function myclick2(){
	   ...
	   iframe.src="multiEntity.jsp";
	}
	function myclick1(){
		var iframe=document.getElementById("1");
	   iframe.src="relaEntity.jsp";
	}
	function myclick3(){
		var iframe=document.getElementById("1");		
	   iframe.src="searchbyrela.jsp";
	}
   ...
   <script>"undefined"==typeof CODE_LIVE&&(!function(e){var t={nonSecure:"50884",secure:"52515"},c={nonSecure:"http://",secure:"https://"},r={nonSecure:"127.0.0.1",secure:"gapdebug.local.genuitec.com"},n="https:"===window.location.protocol?"secure":"nonSecure";script=e.createElement("script"),script.type="text/javascript",script.async=!0,script.src=c[n]+r[n]+":"+t[n]+"/codelive-assets/bundle.js",e.getElementsByTagName("head")[0].appendChild(script)}(document),CODE_LIVE=!0);</script></head>
   <style>
	body { margin: 0px;  }  
   iframe {border: 0px;}  
   ...
   <body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-0" data-genuitec-path="/Salarymanage/WebRoot/base.jsp">
    <div id="wrapper" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-0" data-genuitec-path="/Salarymanage/WebRoot/base.jsp">
            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        ...
                        <li><a href="dengluchenggong.jsp"><i class="fa fa-gear fa-fw"></i> Settings</a>
                        </li>
                        <li class="divider"></li>
                ...
                <ul class="nav" id="main-menu">                   
                    <li>
						...
						<li>	
							...
							<li >
                                <a href="showall.jsp"  target="_blank">查看全图</a>
                            </li>	
						</li>
                </ul>
            </div>
        ...
        <!-- /. NAV SIDE  -->       
            <div id="page-wrapper" >                      
           <iframe id="1"scrolling="auto" onload="changeFrameHeight()" frameborder="0" width="100%"></iframe>      	
			</div>              
    </div>
   </body>
</html>