...
<head>
	...
	text-align:left;
		...
		#visual{	
		position:absolute;width:800px;height:800px;margin:auto;top:220px;left:0;right:0;		
		}
		</style>
		<script>
...
function mysend(){
	...
	<script>
        ...
        function fn2(data) {
            ...
            for (var i = 0; i < data.length; i++) {
                //html+='<li>'+data[i]+'</li>';
                html += '<li><a onclick="getsup2(this)">' + data[i] + '</a></li>';
            }
            oUl.innerHTML = html;
        }
	...
	<script>
        var searchCondition="";
        function getsup(a) {
            var oTxt = document.getElementById('i2');
            oTxt.value = a.innerText;
            change();
        }
        ...
        window.onload = function () {
            ...
            var oTxt2 = document.getElementById('i1');
...
<div id="container">
    <div class="search bar1">
	  ...
	  <div class="btn" style="z-index: 99999999">
