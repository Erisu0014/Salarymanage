	...
	<script type="text/javascript">
        ...
        function MyD3(nodes,links) {
            ...
            var circle = svg.append("g").selectAll("circle").data(force.nodes()).enter().append("circle")
                ...
                .style('stroke',function(node){var color;color="#000080";return color;}).style("stroke-width",3).attr("r", function(node){
                    var r;
                    r = 20+set_r(node.id);
                    return r;
                })
        ...
        function MyVisual(){
            $(document).ready(function() {
                $.ajax({
                    url : "http://47.92.155.245/Salarymanage/Showall",
                    dataType : "json",
                    type : "post",
                    async : true,
